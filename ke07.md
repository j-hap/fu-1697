...
- Beurteilung von Bedienbarkeit der Schnittstelle
...
Wert aus einem festgelegten Definitionsbereich (Skale), beschreibt komprete Beschaffenheit / Ausmaß eines Merkmals
...
### In welche 2 Kategorien können Tests eingeteilt werden?
...
ein parametrischer Test

### Welche Aussage kann mit dem t-Test getroffen werden?
...
Signifikanztest, statischer Test
...
- Mit einer Wahrscheinlichkeit von 5% wird die Nullhypothese auf Grund der Beobachtung als falsch verworden, obwohl sie eigentlich wahr ist.
...
### Was ist der Erwartungswert einer standardisierten Zufallsvariable?

0

### Was ist die Varianz einer standardisierten Zufallsvariable?
...
### Was ist die Kernidee des t-Tests?
...
Differenz der Mittelwerte von Stichproben geteilt durch die gewichtete Varianz
...
### Wann kommen analytisch Evaluationsmethoden im Entwicklungsprozess zum Einsatz?

meist in der frühen Phase und projektbegleitend, wenn es noch keine große Nutzergruppe gibt

### Was ist das Zeiel analytischer Evaluationsmethoden?
...
### Welche Fragen klären beim Abarbeiten der Aktionssequenz im Cognitive Walkthrough die Bedienbarkeit / Erlernbarkeit?
...
heuristische Methoden vernachlässigen entweder die Optimalität der Lösung oder der Rechenzeit. Rechnungen werden mit Schätzungen, Faustregeln, intuitiv-intelligentem Raten oder zusätzlichen Hilfsannahmen zu guten Lösungen geführt

### Wozu dient die *heuristische Evaluation von Benutzungsschnittstellen*?

zeit- und kostengünstige Evaulationsmethode, die primär für Designspezifikation gedacht war, aber auch später zum Einsatz kommt

### Welche Skala kommt bei den *Nielsen Heuristics* zum Einsatz?
...
- keine Erinnerung an andere Dialogteile
...
- Dialoge aufs wesentliche beschränken
...
### Welche modellbasierte Evaluationsmethoden werden vorgestellt?
...
systematisches Verfolgens von Interaktion unter Zuhilfenahme von Notizen, Protokollen oder medialen Aufzeichnungen
...
### Welche Techniken gibt es, um bei Beobachtungen auch über die Bewegggründe für Aktionen Daten zu sammeln?

- lautes Denken
- Post-Testdurchlauf

### Was ermöglichst die Methode des *lauten Denkens*?
...
- Möglichkeit für Vorschläge, Anregungen, Bedenken, die sonst in keiner Antwort geäußert werden könnten
...
### Was ist der Nachteil von den Evaluationstechniken Beobachtung und Fragetechniken?
