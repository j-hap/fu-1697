...
### Welcher Effekt wird einer Radaranzeuge von Flugzeugen (Form + Text) ausgenutzt?
...
### Welcher Winkel sollte zwischen der Ortientierung von Elementen bestehen, um sie möglichst leicht zu unterscheiden?
...
### Auf welchem Gesetz der Wahrnehmung basieren ASCII Emojis?
...
### Bei welche Modalität der Information ist der *Primäreffekt* dominant?
...
- Querlesen wird erleichter
- Kürzen wird erleichter (weniger wichtiges am Ende)
...
kleine, weit entfernte Buttons, denn je Länger ein Benutzer zum Erreichen einer kritischen Schnittstelle benötigt, desto unwahrscheinlicher ist eine versehentliche Betätigung
...
Das System sollte dem Nutzer ein der Wichtigkeit der Handlung entsprechende Rückmeldung geben.
...
Klare Zuordnung von Steuerungselemten zu gesteuerten Zuständen, Wirkung sollte der Eingabe entsprechen (1-zu-1 Beziehnung, Gesetz der Nähe)
...
neue Bedienschemata sparsam einsetzen, aber dafür deren Verwendung standadisieren
