...
### Was ist die grundlager fast aller Schnittstellen zwischen Mensch und Computer?
...
### Aus welchen Schnittstellen liegt klassischerweise der Fokus bei der Informationübertragung vom Menschen zum Computer?

motorische Schnittstellen
...
der kognitive Aufwand bei der Verarbeitung von alphanumerischen Anzeigen ist höher
...
### Wie trackt das am MDI entwickelte System, das die Bewegungsparallaxe nutzt, die Kopfposition des Betrachters?
...
### Was ist der Nachteil von Polarisationsbrille?
...
### Wie entsteht der "Tunnelblicks" bei HMD VR-Systemen?
...
### Was ist *Fixed Foveated Rendering* nötig?
...
### Was sind drei grundlegende Characteristika von auditiver Informationsübertragung?

- auditive Informationsübertragung findet nur für eine gewisse Dauer nach Initialisierung statt. Bei visualler Übertragung steht die Information "abrufbar" bereit ohne aktualisiert werden zu müssen.
- ungerichtet
- schlechter abschirmbar als visualle Informationen
-
...
mit speziellen Ausgabegeräten (Eichtlautsprecher)

### Was ist Vorraussetzung für eine visualle Informationsübertragung
...
### Wie wird die Benutzung von Geräuschlosen Geräten empfungen?

schwammig und unpräzise

### Wozu dient einfachen akustisches Feedback?
...
### Was ist bei aktustischem Feedback für virtuelle Tasten wichtig?
...
das interne Modell des Systems
...
spürbarer Druckpunkt, der vermitteln, wann Betätigung stattgefunden hat
...
### Wie funktioniert ein haptisches Eingabegerät?
...
### In welche Kategorien von Gleichgewichtslagen fallen praktisch alle Interaktionsmechanismen?

stabil und indifferent
...
### Was ist ein Beispiel für einen indifferenten Mechanismus?
...
### Wie entstand das heute üblige QUERTY / QWERTZ Tastaturlayout?
...
Die Anzahl der Benutzer und Benutzerinnen, die bereits gewisse Fertigkeiten im Umgang mit dem klassischen Tastaturlayout haben, ist schlicht zu groß und der erwartete Zugewinn ist zu klein, als dass sich eine Mehrheit für einen Umstieg auf ein neues Tastaturlayout
entscheiden würde.
...
### Welches Feedback geben alle Schalter und Reglner?
...
### Was zeichner komplete, haptische Interaktionsmechanismen aus?
...
Eine Kugel im inneren treibt beim Gleiten der Maus zwei Achsen an, die die horizontale und vertikale Geschwindigkeit des Mauszeigers bestellen
...
### Was sind die Ausgaben einer Computermaus?
...
### Welche Brancher ist Vorreiter im Bereich der semantischen Interpretation von Kameradaten?
...
### Wie kann die semantischen Interpretation von Videodaten robuster gegeüber Störungen gestaltet werden?
...
### In welchem Lichts arbeitet Playstation Move?
...
### Welche Vorteile hat die Wii-Remote gegenüber Playstaion Move?

- Nutzung von Infrarot ist robuster
- eigener Chip für Positionberechnung
- höhere Abtastrate (100 Hz vs 30 Hz)

### Welche Vorteile hat Playstaion Move gegenüber der Wii-Remote?
...
### Welche Sensoren sind im Controller bei Playstaion Move verbaut?

- 3-Achsen-Beschleunigungssensor
- 3-Achsen-Drehratensensor
- Magnetfeldsensor

### Welche Gemeinsamkeiten haben Playstaion Move und die Wii-Remote?
...
### Womit werden bei Microsoft Kinect die Gesten der Spieler erkannt?
...
dreidimensionalen Erfassung des Spielers
...
- Weitwinkelkameras zur optischen Umgebungserfassung, aus markanten Punkten wird über Zeit eine 3D Karte des Raums erstellt
...
Bestimmung der Entfernung eines Punktes über drei (Tri) Referenzpunkte
...
Über mehrere Sensoren in definiertem Abstand am Objekt kann die Orientierung zu den Sendern festgestellt werden.
